...
namespace Orleans.StorageProvider.RavenDB.TestInterfaces
{
    ...
    public class PersonFactory
    {
        ...
        [Orleans.GrainReferenceAttribute("Orleans.StorageProvider.RavenDB.TestInterfaces.IPerson")]
        internal class PersonReference : Orleans.GrainReference, IPerson, Orleans.IAddressable
        {
            ...
            public static IPerson Cast(IAddressable grainRef)
            {
                ...
                return (IPerson) GrainReference.CastInternal(typeof(IPerson), (GrainReference gr) => { return new PersonReference(gr);}, grainRef, 438111581);
            }

                protected override int InterfaceId { get { return 438111581; } }

                public override bool IsCompatible(int interfaceId) { return interfaceId == this.InterfaceId; }

                protected override string InterfaceName { get { return "Orleans.StorageProvider.RavenDB.TestInterfaces.IPerson"; } }
            ...
            public System.Threading.Tasks.Task<Orleans.StorageProvider.RavenDB.TestInterfaces.GenderType> Gender
            {
                get
                {

                return base.InvokeMethodAsync<Orleans.StorageProvider.RavenDB.TestInterfaces.GenderType>(871790933, new object[] {}, TimeSpan.Zero , options: InvokeMethodOptions.ReadOnly);
                }
            }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Orleans-CodeGenerator", "1.0.814.60418")]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverageAttribute()]
    [Orleans.MethodInvokerAttribute("Orleans.StorageProvider.RavenDB.TestInterfaces.IPerson", 438111581)]
...
static public System.Threading.Tasks.Task<PersonProperties> GetProperties(this IPerson interfaceData) 
    ...
    public class EmailFactory
    {
        ...
        internal class EmailReference : Orleans.GrainReference, IEmail, Orleans.IAddressable
        {
            ...
            public System.Threading.Tasks.Task<System.Nullable<System.DateTimeOffset>> SentAt
            {
                get
                {

                return base.InvokeMethodAsync<System.Nullable<System.DateTimeOffset>>(440206751, new object[] {}, TimeSpan.Zero , options: InvokeMethodOptions.ReadOnly);
                }
            }
                ...
                switch (interfaceId)
                {
                    case 938089621:  // IEmail
                        switch (methodId)
                        {
                            ...
                            case 440206751: 
                                return await ((IEmail)grain).SentAt;
...
static public System.Threading.Tasks.Task<EmailProperties> GetProperties(this IEmail interfaceData) 
    ...
    internal class Orleans_StorageProvider_RavenDB_TestInterfaces_PersonalAttributesSerialization
    {
        ...
        {
            Orleans.Serialization.SerializationManager.Register(typeof(Orleans.StorageProvider.RavenDB.TestInterfaces.PersonalAttributes), DeepCopier, Serializer, Deserializer);
        }
    }
}
